function love.conf(t)
    ...
    t.window.title = "Walter on a boating trip"         -- The window title (string)
    t.window.icon = 'walter.png'                 -- Filepath to an image to use as the window's icon (string)
    ...
    t.window.depth = 32                 -- The number of bits per sample in the depth buffer
