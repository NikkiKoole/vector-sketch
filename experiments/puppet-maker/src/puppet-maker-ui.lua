      ...
      for i = -1, (scroller.visibleOnScreen - 1) do
         ...
         if draw then
            ...
            if uiState.selectedCategory == categories[index] then
               ...
               love.graphics.draw(ui2.rects[1], xPos, yPosition, 0, sx * sm, sy * sm)
               love.graphics.setColor(0, 0, 0, alpha)
            end
            ...
            if (ui2.scrollIcons[categories[index]]) then
               ...
               love.graphics.draw(ui2.scrollIcons[categories[index]], xPos, yPosition, 0, sx * sm,
                   sy * sm,
                   alpha)
               ...
               if (m) then
                  ...
                  love.graphics.draw(m, xPos, yPosition, 0, sx * sm, sy * sm)
               end
            else
