...
function handleChild3d(shape, t)
   if shape.folder then
      ...
      if shape.m3d then
         ...
         shape.m3d:draw2(shape._parent._globalTransform , defaultshader)
         if shape.m3dSides then
            shape.m3dSides:draw2(shape._parent._globalTransform , defaultshader)

         end
          if shape.m3dOther then
            shape.m3dOther:draw2(shape._parent._globalTransform, defaultshader )
